import{_ as e,o as n,c as a,a as s}from"./app.860be1bc.js";const i={},t=s(`<h1 id="getting-started" tabindex="-1"><a class="header-anchor" href="#getting-started" aria-hidden="true">#</a> Getting Started</h1><h2 id="install-our-cli" tabindex="-1"><a class="header-anchor" href="#install-our-cli" aria-hidden="true">#</a> Install our CLI</h2><p>To get started, run the following to get our CLI tools:</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">yarn</span> global <span class="token function">add</span> @pixel-builder/cli
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>You will be asked few questions about what kind of project and options you would like.</p><p>Then when you finished</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># open your project</span>
