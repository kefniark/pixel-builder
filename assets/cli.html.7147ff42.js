import{_ as n,o as a,c as s,a as e}from"./app.ab229e2d.js";const i={},l=e(`<h1 id="pixel-cli" tabindex="-1"><a class="header-anchor" href="#pixel-cli" aria-hidden="true">#</a> Pixel CLI</h1><h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2><p>The Pixel CLI is the core of pixel builder, it&#39;s what allow to create, develop and build projects.</p><h2 id="to-install-or-update" tabindex="-1"><a class="header-anchor" href="#to-install-or-update" aria-hidden="true">#</a> To install or update</h2><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">yarn</span> global <span class="token function">add</span> @pixel-builder/cli
